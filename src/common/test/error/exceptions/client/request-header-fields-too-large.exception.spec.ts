...
import { RequestHeaderFieldsTooLargeException } from '../../../../errors';
import {
  getHttpStatusDefaultMessage,
  getHttpStatusDefaultTitle,
} from '../../../../utils';

describe('RequestHeaderFieldsTooLargeException', () => {
  describe('constructor', () => {
    describe('with arguments', () => {
      it('should return an instance with custom values', () => {
        const error = new RequestHeaderFieldsTooLargeException('Error Test', {
